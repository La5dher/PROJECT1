 ...
 */
final class Version20240521064014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT NOT NULL, categorie VARCHAR(255) DEFAULT NULL, nom_entreprise VARCHAR(255) NOT NULL, approuve TINYINT(1) NOT NULL, date_de_creation DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etudiant (id INT NOT NULL, nce INT DEFAULT NULL, niveau VARCHAR(255) DEFAULT NULL, institut VARCHAR(255) DEFAULT NULL, date_naissance DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, id_entreprise_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, competence VARCHAR(255) DEFAULT NULL, typeemploi VARCHAR(255) DEFAULT NULL, lieutravail VARCHAR(255) DEFAULT NULL, INDEX IDX_C27C93691A867E8F (id_entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
